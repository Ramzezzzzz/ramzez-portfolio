...
export default function BlogPanel() {
  ...
  // Инициализация всех виджетов VK после того, как посты отрендерились
  useEffect(() => {
  ...
  return (
    <div className="blog-panel" ref={containerRef}>
      ...
      <div className="flex flex-col items-center gap-6">
        {/* ОДНА общая карточка */}
        <div
          className="w-full max-w-[700px] mx-auto p-5 rounded-2xl transition-all duration-300"
          style={{
            ...
            {posts.map((post) => {
              ...
              return (
                <div key={containerId} className="border-b border-red-500/20 last:border-0 pb-4 last:pb-0">
                  ...
                  <div
                    id={containerId}
                    className="vk-post-widget w-full"
